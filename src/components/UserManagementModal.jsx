...
import { X, UserPlus, Shield, Trash2, KeyRound, Check, AlertCircle, Eye, EyeOff } from 'lucide-react';
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <input 
                    ...
                    placeholder="Senha"
                    className="w-full pl-3 pr-9 py-2 bg-white border border-slate-300 rounded-xl text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <button 
                    type="button" 
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-2 top-1/2 -translate-y-1/2 p-1 text-slate-400 hover:text-slate-600 rounded-lg cursor-pointer"
                  >
